...
public interface ReadWrite {
     ...
     * @author Ronan
     */
    default ArrayList<String> readFile(File f){
     ...
     * @author Ronan
     */
    default void updateFile(File f, ArrayList<String> s){
        try{
            if(f.length()==0){
     ...
     * @author Ronan
     */
    default void writeFile(File f,String s){
     ...
     * @author Ronan
     */
    default void updateFile(File f, String s){
        ArrayList<String> arr = new ArrayList<>();
        arr.add(s);
        updateFile(f,arr);
    }
     ...
     * @author Ronan
     */
    default void deleteFile(File f) {
        f.delete();
    }
